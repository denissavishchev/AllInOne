    ...
    static func mocData() -> [Product]{
        ...
        Product(
            ...
            reviews: Reviews(
                ...
                count: 19,
                review: [
                    Review(name: "Denis", date: "24.10.28", description: "We really enjoyed the taste of this tea and certainly a very good price. However we have had many broken strings that has not happened with the Tetley tea bags that we usually have. Getting a teaspoon out to fish out the teabag is putting me off buying this product again", rating: 5),
                    Review(name: "Leonard", date: "24.10.27", description: "This has been my favourite tea for quite a while. Nice to see it do well in the recommendations. As noted, it has a extremely slight fruity flavour, but certainly not herbal. Different to other black teas, but still a black tea.", rating: 4),
                    Review(name: "Daniel", date: "24.09.28", description: "Lacks body. Initially slightly sweet, but left an unpleasant and lingering aftertaste.", rating: 3)
                ]
            )
        ),
        ...
        Product(
            ...
            reviews: Reviews(
                ...
                count: 13,
                review: [
                    Review(name: "Denis", date: "24.10.28", description: "Came in today for the first time and my goodness I don’t think I could ever eat cookies anywhere else! They had a wonderful variety (including Gluten Free) and I’m sure you can’t go wrong with any choice that you make. They even had treats for my fur babies. Thank…", rating: 3),
                    Review(name: "Leonard", date: "24.10.27", description: "Awesome fresh cookies. Support local!", rating: 4),
                    Review(name: "Daniel", date: "24.09.28", description: "The company I work for uses their cookies for client thank you gifts. Our clients are always happy and love them. I signed up myself for the monthly cookie tin and it was the best decision! They are so good and I never know what I’m getting and makes me…", rating: 5)
                ]
            )
        ),
